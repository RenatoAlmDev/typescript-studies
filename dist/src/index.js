...
function accelerate(targetSpeed, spaceship) {
    if (spaceship.speed > targetSpeed) {
        alert(`Reduzindo a velocidae da ${spaceship.name} para ${targetSpeed}`);
    }
    else if (spaceship.speed < targetSpeed) {
        alert(`Aumentando a velocidae da ${spaceship.name} para ${targetSpeed}`);
    }
    else {
        alert(`Mantendo a velocidae da ${spaceship.name}...`);
    }
}
